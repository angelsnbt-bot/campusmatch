  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      <div className="relative">
        <div className="h-48 md:h-64 w-full rounded-3xl bg-gradient-to-br from-primary/20 via-secondary/10 to-background overflow-hidden relative border border-white/5">
        </div>
