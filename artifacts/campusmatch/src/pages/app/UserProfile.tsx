...
export default function UserProfile() {
  ...
  if (!profile) {
    return <div className="text-center py-20 text-white/50" style={{ fontFamily: 'Outfit' }}>User not found</div>;
  }

  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      <div className="relative">
        <div className="h-48 md:h-64 w-full rounded-3xl bg-gradient-to-br from-pink-500/20 via-purple-500/10 to-[#0d0810] overflow-hidden relative border border-white/5">
        </div>

        <div className="absolute left-8 -bottom-16 flex items-end gap-6">
          <div className="w-32 h-32 rounded-2xl bg-card border-4 border-[#0d0810] overflow-hidden shadow-2xl">
            {profile.avatarUrl ? (
      ...
      <div className="mt-20 px-2">
        ...
        <div className="mt-8 space-y-8">
          <div>
            <h3 className="text-sm font-bold text-white/40 uppercase tracking-wider mb-3" style={{ fontFamily: 'Cabin' }}>About</h3>
