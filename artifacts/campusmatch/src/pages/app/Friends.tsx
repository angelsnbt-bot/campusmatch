...
import { useGetConnections, useGetConnectionRequests, useAcceptConnection, useSendConnectionRequest } from '@workspace/api-client-react';
        ...
        isLoadingFriends ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {connections?.map(conn => (
              <div key={conn.id} className="glass-card p-4 rounded-2xl flex items-center gap-4">
      ...
      {activeTab === 'requests' && (
        isLoadingRequests ? (
          ...
          <div className="space-y-4">
            {requests?.map(req => (
              <div key={req.id} className="glass-card p-4 rounded-2xl flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-white/10 overflow-hidden shrink-0">
