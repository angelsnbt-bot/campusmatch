      ...
      <motion.div initial={{ opacity: 0, y: 30, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ type: 'spring', stiffness: 300, damping: 25 }}
        ...
        <div className="glass-card p-8 rounded-2xl overflow-hidden">
          ...
          {step === 1 && (
            <>
              {isGoogleAvailable ? (
                <div id="google-signin-btn-register" className="flex justify-center mb-4 [&>div]:w-full [&>div]:!bg-white/[0.06] [&>div]:!rounded-xl [&>div]:!h-11 [&>div]:!border [&>div]:!border-white/10 [&>div]:!shadow-none [&_iframe]:!h-11" />
              ) : (
