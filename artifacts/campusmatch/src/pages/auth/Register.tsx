    ...
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 mb-6">
          {[1, 2, 3].map((s) => (
            <div key={s} className={`h-1.5 rounded-full transition-all ${s === step ? 'w-8 bg-primary' : s < step ? 'w-4 bg-primary/50' : 'w-4 bg-white/20'}`} />
          ))}
        </div>
          ...
          {step === 2 && (
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="erp"
                  placeholder="Your ERP enrollment number"
                  value={erpNumber}
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="flex-1 bg-gradient-to-r from-primary to-secondary hover:opacity-90 text-white border-0"
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-4">
              <div className="space-y-2">
                ...
                <div
                  ...
                  className="w-24 h-24 mx-auto rounded-full bg-white/5 border-2 border-dashed border-white/20 flex items-center justify-center cursor-pointer hover:border-primary/50 transition-colors overflow-hidden"
                >
                  {photoPreview ? (
              ...
              <div className="flex items-start gap-3 pt-2">
                ...
                <Label htmlFor="terms" className="text-white/60 text-xs leading-relaxed cursor-pointer">
                  ...
                  <a href="/privacy" target="_blank" className="text-primary hover:underline">Privacy Policy</a>. I confirm I am a
                  current VGU student and the information provided is accurate.
                </Label>
              </div>
